...
export default function CoreConceptCard({ concepts }: CoreConceptCardProps) {
  return (
    <div className="space-y-4">
      <h3 className="text-xl font-jua text-white drop-shadow-sm flex items-center gap-2 select-none px-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {concepts.map((concept, i) => (
          ...
          >
            ...
            <div>
              <p className="font-jua text-base leading-tight text-white">{concept.title}</p>
