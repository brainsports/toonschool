    ...
    <div style={{
      ...
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
        ...
        {cover.bgPattern.map((decor, index) => {
          ...
          const positions = [
            { left: '6%', top: '22%', fontSize: 24 },
            { right: '8%', top: '25%', fontSize: 22 },
            { left: '12%', top: '35%', fontSize: 20 },
            { right: '12%', top: '42%', fontSize: 18 },
            { left: '8%', top: '48%', fontSize: 20 },
            { right: '6%', top: '55%', fontSize: 24 },
            { left: '10%', top: '65%', fontSize: 22 },
            { right: '10%', top: '70%', fontSize: 18 },
            { left: '20%', top: '15%', fontSize: 14 },
            { right: '22%', top: '18%', fontSize: 14 },
          ]
